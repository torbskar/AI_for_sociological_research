...
Agha, R. A., G. Mathew, R. Rashid, A. Kerwan, A. Al-Jabir, C. Sohrabi, T. Franchi, M. Nicola, M. Agha, and TITAN Group. 2025. "Transparency in the Reporting of Artificial Intelligence — the TITAN Guideline." *Premier Journal of Science* 10: 100082.

Asher, S., J. Malzahn, E. Paschal, J. Persano, A. C. W. Myers, and A. B. Hall. 2026. "Sycophancy and Statistical Analysis in Large Language Models." Working paper. https://andrewbenjaminhall.com/asher_et_al_LLM_sycophancy.pdf

Barrie, C., A. Palmer, and A. Spirling. 2025. "Replication for Language Models: Problems, Principles, and Best Practice for Political Science." Working paper. https://arthurspirling.org/documents/BarriePalmerSpirling_TrustMeBro.pdf
...
Ganjavi, C., M. B. Eppler, A. Pekcan, B. Biedermann, A. Abreu, G. S. Collins, I. S. Gill, and G. E. Cacciamani. 2024. "Publishers' and Journals' Instructions to Authors on Use of Generative Artificial Intelligence in Academic and Scientific Publishing: Bibliometric Analysis." *BMJ* 384: e077192. https://doi.org/10.1136/bmj-2023-077192.
...
Holst, D., K. Moenck, J. Koch, O. Schmedemann, and T. Schüppstuhl. 2025. "Transparent Reporting of AI in Systematic Literature Reviews: Development of the PRISMA-trAIce Checklist." *JMIR AI* 4: e80247.
...
Kosch, Thomas, and Sebastian Feger. 2025. "Prompt-Hacking: The New p-Hacking?" arXiv preprint. https://doi.org/10.1145/3744911. [*flag: DOI resolves to ACM publication (August 2025) — verify final venue, volume/issue details before submission*]

Krippendorff, K. 2019. *Content Analysis: An Introduction to Its Methodology*. 4th ed. Thousand Oaks, CA: SAGE Publications.

Ludwig, J., S. Mullainathan, and A. Rambachan. 2024. "Large Language Models: An Applied Econometric Framework." arXiv preprint 2412.07031. https://arxiv.org/abs/2412.07031.

Mitchell, R. L. C., P. Holton, T. Chandola, J. Payne, J. Abell, and J. Ward. 2022. "Where Does All the 'Know How' Go? The Role of Tacit Knowledge in Research Impact." *Higher Education Research & Development* 42 (2): 1664–1678. [*Author flag: PDF in project library (rhs-mitchell-knowhow) shows different authors — Vincent-Wayne Mitchell, William S. Harvey, and Geoffrey Wood — and different volume/issue (41(5)). Verify correct entry before submission.*]

Momeni, F., M. T. Khan, J. Kiesel, and T. Ross-Hellauer. 2025. "Checklists for Computational Reproducibility in Social Sciences: Insights from Literature and Survey Evaluation." In *Proceedings of the 3rd ACM Conference on Reproducibility and Replicability (ACM REP '25)*, 179–191.

Mondal, H., S. Mondal, and J. K. Behera. 2025. "Artificial Intelligence in Academic Writing: Insights from Journal Publishers' Guidelines." *Perspectives in Clinical Research* 16 (1): 56–57. [*Note: year corrected from 2024 to 2025 — verify before submission*]
...
Pruschak, G., and F. Hopp. 2022. "Do Social Scientists Adhere to Authorship Criteria? A Survey Study." *PLOS ONE* 17 (5): e0267312.
...
Sibbald, K. R., S. K. Phelan, B. L. Beagan, and T. M. Pride. 2025. "Positioning Positionality and Reflecting on Reflexivity: Moving from Performance to Practice." *Qualitative Health Research* 35 (1–2). [*incomplete — page numbers needed; was online first (0(0)) at time of last check*]
...
Zeng, J., et al. 2025. "AIRepr: An Analyst-Inspector Framework for Evaluating Reproducibility of LLMs in Data Science." In *Findings of the Association for Computational Linguistics: EMNLP 2025*. [*Author flag: full author list needed*]

Zrubka, Z., L. Kovács, H. Motahari Nezhad, et al. 2023. "Artificial Intelligence in Medicine: A Systematic Review of Guidelines on Reporting and Interpreting Studies." Preprint. [*Author flag: full author list needed*]
